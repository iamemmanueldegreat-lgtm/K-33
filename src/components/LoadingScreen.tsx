        ...
        <AnimatePresence>
          {phase === 'logo' && (
            <motion.div
              ...
              className="absolute inset-0 flex items-center justify-center"
            >
              <div className="w-16 h-16 rounded-full bg-[#1A1A1A] border-2 border-teal-500/30 shadow-xl flex items-center justify-center overflow-hidden">
                <img src="/logo.png" alt="KortexAi Logo" className="w-full h-full object-cover" />
              </div>
            </motion.div>
          )}
        </AnimatePresence>
      ...
      <AnimatePresence>
        {phase === 'logo' && (
          <motion.div
            ...
            className="absolute inset-0 flex items-center justify-center"
          >
            <div className="w-12 h-12 rounded-full bg-[#1A1A1A] border-2 border-teal-500/30 shadow-xl flex items-center justify-center overflow-hidden">
               <img src="/logo.png" alt="KortexAi Logo" className="w-full h-full object-cover" />
            </div>
          </motion.div>
        )}
