      ...
      <div className="px-4 space-y-5">
        ...
        {user?.is_admin && (
          <motion.button
            ...
            whileTap={{ scale: 0.97 }}
            className="flex items-center gap-4 w-full bg-gradient-to-r from-[#1a1a20] to-[#22222c] text-white rounded-2xl p-4 border border-amber-500/20 shadow-md text-left"
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-sm font-bold text-white truncate">Internal Admin Panel</p>
            </div>
