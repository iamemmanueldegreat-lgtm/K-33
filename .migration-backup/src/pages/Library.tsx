                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="space-y-1 sm:space-y-1.5 relative z-10 flex-1 flex flex-col justify-center select-none pt-2">
                        <span className="text-[12px] sm:text-[14px] font-bold tracking-widest uppercase block font-mono bg-white/60 text-black px-2.5 py-0.5 rounded-md w-max shadow-sm border border-black/5">
                          {course.code}
                        </span>
