  ...
  return (
    <div className="fixed inset-0 w-full h-full bg-white dark:bg-[#121212] text-black dark:text-white font-sans overflow-hidden flex flex-col select-none z-50">
      ...
      <div className="relative w-full h-[48vh] sm:h-[50vh] lg:h-[54vh] shrink-0 overflow-hidden z-10 flex flex-col items-center justify-end pb-8">
        ...
        {/* Sleek premium glowing mesh placeholder that is visible instantly before background image loads */}
        <div className="absolute inset-0 bg-gradient-to-tr from-cyan-600/20 via-[#0b2d39]/30 to-[#121212]/20 dark:from-sky-950/30 dark:via-zinc-900/35 dark:to-zinc-950/20 animate-pulse" />
        ...
        <img 
          ...
          className={`absolute inset-0 w-full h-full object-cover pointer-events-none transition-all duration-[2000ms] ${
            imageLoaded ? 'opacity-100 scale-100 filter-none' : 'opacity-0 scale-[1.03] blur-md'
          }`}
